const CSSHelper = require('./cssUtils')
const LayoutHelper = require('./layout')
...
function emit(token){
    ...
    if(token.type == "startTag"){
        ...
        // 计算元素能够匹配那些CSS规则,越早越好，我们一般是在STARTTAG的时候就计算
        CSSHelper.computeCSS(stack, element)
        ...
        if(top.tagName != token.tagName){
            ...
            // flex 是要知道子元素的，而子元素是发生在endTag之前
            LayoutHelper.layout(top)
